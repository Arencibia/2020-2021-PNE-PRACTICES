...
class Seq:
    ...
    def percentage_base(self, count_bases, seq_len):
        a = str(count_bases[0]) + " (" + str(round(count_bases[0] / seq_len * 100, 1)) + "%)"
        c = str(count_bases[1]) + " (" + str(round(count_bases[1] / seq_len * 100, 1)) + "%)"
        g = str(count_bases[2]) + " (" + str(round(count_bases[2] / seq_len * 100, 1)) + "%)"
        t = str(count_bases[3]) + " (" + str(round(count_bases[3] / seq_len * 100, 1)) + "%)"
